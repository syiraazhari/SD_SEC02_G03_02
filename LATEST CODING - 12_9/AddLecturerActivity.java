...
public class AddLecturerActivity extends Activity {
        ...
        registerButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(first_name)) {
                    ...
                    DBAdapter dbAdapter = new DBAdapter(AddLecturerActivity.this);
                    dbAdapter.addFaculty(facultyBean);

                    Intent intent =new Intent(AddLecturerActivity.this,MenuActivity.class);
