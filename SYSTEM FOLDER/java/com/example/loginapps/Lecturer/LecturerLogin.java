...
import com.example.loginapps.Profile.RegistrationActivity;
...
public class LecturerLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            finish();
            startActivity(new Intent(LecturerLogin.this, LecturerHomePageActivity.class));
        }
        ...
        userRegistration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LecturerLogin.this, RegistrationActivity.class));
            }
        });
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LecturerLogin.this, PasswordActivity.class));
        ...
        Department.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LecturerLogin.this, SecondMainActivity.class));
            }
        });
        ...
        firebaseAuth.signInWithEmailAndPassword(userName, userPassword)
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(LecturerLogin.this, "com.example.loginapps.Login Successful",
                            Toast.LENGTH_SHORT).show();
                    checkEmailVerification();
                } else {
                    Toast.makeText(LecturerLogin.this, "com.example.loginapps.Login Failed",
                            Toast.LENGTH_SHORT).show();
                    counter--;
